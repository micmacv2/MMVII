...
std::vector<cSpecMMVII_Appli *> & cSpecMMVII_Appli::InternVecAll()
{
   if (TheVecAll.size() == 0)
   {
        ...
        TheVecAll.push_back(&TheSpec_GenerateRandomDelaunay);
        ...
        TheVecAll.push_back(&TheSpec_GenerateSmoothSineImage);
        TheVecAll.push_back(&TheSpec_GenerateConstrainedDelaunay);
        TheVecAll.push_back(&TheSpec_ComputeConstrainedTriangleDeformation);
